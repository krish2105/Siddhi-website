...
export const ProductDetailView: React.FC<ProductDetailViewProps> = ({ onAddToCart, onBackToHome }) => {
        ...
        >
          ...
          <div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ textAlign: 'right' }}>
                        <span style={{ fontWeight: 800, fontSize: '16px' }}>{formatINR(bundle.price)}</span>
                      </div>
                    </div>
                  );
                })}
            ...
            <div style={{ display: 'flex', gap: '14px', marginBottom: '24px' }}>
              ...
              >
                Order {selectedBundle.name} • {formatINR(selectedBundle.price)}
              </button>
            </div>
